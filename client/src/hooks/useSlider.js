...
//       const containerWidth = containerRef.current.clientWidth; // width slider
//       const itemWidth = containerRef.current.firstChild.clientWidth; // width item slider
//       const totalInViewport = Math.ceil(containerWidth / itemWidth); // max item in 1 slider view

//       setSlider(containerRef.current.children); // children of slider-container
//       setContainerWidth(containerWidth);
//       setTotalInViewport(totalInViewport);
//       setSliderPages(countElements / totalInViewport); //page of slider
//     }
...
//     // nPages la page of slider === sliderPages
//     let paginationList = [];
